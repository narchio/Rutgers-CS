...
int* toBinary (int* binary, int rows, int inputs, int i) {
    // this variable will be the correct indeces of the columns, minus 1 because we need to start over from the max inputs because our indeces start at 0 not 1
    int count = inputs-1; 
